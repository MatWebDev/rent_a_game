...
game = Game.new(
  ...
  address: "Boulevard Louis Picon, Toulon",
  price_per_day: rand(1.0..10.00).round(2),
  disponibility: true,
  user_id: User.all.sample.id
)
...
game = Game.new(
  ...
  address: "rue de la Verrerie, Aix-en-Provence",
  price_per_day: rand(1.0..10.00).round(2),
  disponibility: true,
  user_id: User.all.sample.id
)
...
game = Game.new(
  ...
  address: "Avenue de la Corse, Marseille",
  price_per_day: rand(1.0..10.00).round(2),
  disponibility: true,
  user_id: User.all.sample.id
)
...
game = Game.new(
  ...
  address: "Rue de la Joliette, Marseille",
  price_per_day: rand(1.0..10.00).round(2),
  disponibility: true,
  user_id: User.all.sample.id
)
